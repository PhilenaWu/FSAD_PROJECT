  ...
  FOR rec IN
    SELECT * FROM (VALUES
      ('KONE Maintenance',   'service@konemaint.com.sg',  'Marcus Tan',   'Service Manager',
       'marcus.tan@konemaint.com.sg',   DATE '2025-08-01', DATE '2026-07-31', 'active',
      ...
      ('KONE Pte Ltd',       'support@kone-sg.com',       'Priya Nair',   'Account Director',
       'priya.nair@kone-sg.com',        DATE '2026-01-01', DATE '2027-12-31', 'active',
      ...
      ('Otis Elevator Co.',  'service@otiselevator.sg',   'Wei Jie Lim',  'Operations Lead',
       'wei.jie.lim@otiselevator.sg',   DATE '2025-01-01', DATE '2026-12-31', 'active',
      ...
      ('Otis Service SG',    'defects@otisservice.sg',    'Sarah Chen',   'Maintenance Supervisor',
       'sarah.chen@otisservice.sg',     DATE '2026-03-01', DATE '2027-02-28', 'active',
      ...
      ('Schindler Care',     'alerts@schindlercare.sg',   'Ahmad Faizal', 'Service Director',
       'ahmad.faizal@schindlercare.sg', DATE '2024-07-01', DATE '2026-06-30', 'suspended',
      ...
      ('Schindler Lifts SG', 'defects@schindlerlifts.sg', 'Grace Ho',     'Regional Manager',
       'grace.ho@schindlerlifts.sg',    DATE '2026-06-01', DATE '2028-05-31', 'active',
       'Manages Schindler lift servicing and e-sign completions for the estate')
    ) AS t(company, contact, holder, title, login, cstart, cend, ustatus, reason)
  LOOP
