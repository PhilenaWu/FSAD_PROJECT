...
8. Admin drills into the job-level table, exports to CSV, prints a snapshot, or exports a server-rendered PowerPoint deck (`POST /api/export/admin-costs-pptx`, admin-only).
