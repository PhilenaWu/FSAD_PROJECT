...
| R18 | "Admin / user control · add new equipment and users with rights" | UC-012 | Hasini | **Built** — vendor API, cron-guarded expiry job and daily workflow, `AdminVendorPage`, audit trail in `vendor_history`; covered by `tests/Ginjala_Hasini/vendors.test.js` |
