// Shared ADMIN app layout: a top header (logo, nav, notification placeholder,
// user menu) above the routed page via <Outlet />. Structural clone of
// ManagerLayout.jsx — kept separate because the admin nav (Cost Analytics,
// Vendors) and the "Administrator" subtitle diverge from the manager shell.
